...
import { nextWeeklyResetDateText, usePairPlayModel } from "./usePairPlayModel";
...
export function PairPlayTab() {
  ...
  return (
    <>
      ...
      {!model.ordered.length && !model.showSavedOnlyCard ? (
        <>
          {model.allCurrentAnswered ? (
            <div className="v3-success" data-testid="all-answered-state">
              ...
              <div className="hint">
                ...
                direkt selbst beantworten. Danach erscheint sie bei deinem Partner und kann auch von
