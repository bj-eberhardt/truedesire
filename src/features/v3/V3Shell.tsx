...
export function V3Shell(props: V3ShellProps) {
  ...
  useEffect(() => {
    ...
    if (routeMode !== 'pair' && routeMode !== 'pairMatches' && routeMode !== 'pairSettings' && routeMode !== 'ask' && routeMode !== 'played') return
      ...
      <main className="v3">
        <div className="v3-container">
          ...
          {(routeMode === 'pair' || routeMode === 'pairMatches' || routeMode === 'pairSettings') && routePairId ? (
            <PairPage
              pairId={routePairId}
              activeTab={routeMode === 'pairMatches' ? 'matches' : routeMode === 'pairSettings' ? 'settings' : 'play'}
              ...
              allowAllQuestions={props.v2AllowAllQuestions}
              setAllowAllQuestions={props.setV2AllowAllQuestions}
            ...
            <PlayedPage pairId={routePairId} pair={props.pair} questions={props.questions} answerSummary={props.answerSummary} onBack={() => goV3Pair(routePairId)} onAnswer={props.onAnswer} />
          ) : routeMode === 'backup' ? (
            <BackupPage
